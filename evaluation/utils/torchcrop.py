...
def add_phenology_columns(
    ...
    Args:
        frame: Simulation rows carrying ``days_to_maturity``.
        sowing_doy: The run's constant sowing latch.
    ...
    out["sowing_doy"] = float(sowing_doy)
    out["maturity_doy"] = wrap_doy(sowing_doy + days)
    out["harvest_doy"] = wrap_doy(sowing_doy + days + harvest_lag_days)
